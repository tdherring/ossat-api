...
# test_best_fit = BestFit()

# # Create the blocks.

# test_best_fit.create_block("b1", 100)
# test_best_fit.create_block("b2",500)
# test_best_fit.create_block("b3",200)
# test_best_fit.create_block("b4",300)
# test_best_fit.create_block("b5",600)

# # Create the processes.
# test_best_fit.create_process("p1", 212)
# test_best_fit.create_process("p2", 417)
# test_best_fit.create_process("p3", 112)
# test_best_fit.create_process("p4", 426)
# test_best_fit.allocate_processes(True)
